...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _this.axios.get("/api/Client").then(function (response) {
                  _this.Client_count = response.data.Client_count;
                });
    ...
    CountInvoice: function CountInvoice() {
      var _this2 = this;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _this2.axios.get("/api/Invoice").then(function (response) {
                  _this2.Invoice_count = response.data.Invoice_count;
                });
      ...
      _c("div", [
        _c(
          ...
          [
            _c(
              "router-link",
              { staticClass: "nav-item nav-link", attrs: { to: "/Client" } },
              [_vm._v("Clients >")]
            )
          ],
          1
      ...
      _c("div", [
        _c(
          ...
          [
            _c(
              "router-link",
              { staticClass: "nav-item nav-link", attrs: { to: "/Invoice" } },
              [_vm._v("Invoice >")]
            )
          ],
          1
